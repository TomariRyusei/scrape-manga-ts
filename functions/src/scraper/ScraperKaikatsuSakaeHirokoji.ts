...
export class ScraperKaikatsuSakaeHirokoji implements IScraper {
  readonly storeName: string = "快活クラブ 栄広小路店";
  readonly url: string = "https://www.navi-comi.com/20488/arrival-list/";
